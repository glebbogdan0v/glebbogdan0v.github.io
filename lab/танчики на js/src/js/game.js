  ...
  var audio = new Audio();
  song = new Array(10);
song[0] ='src/music/Rammstein-AUSLÄNDER-kissvk.com.mp3'
song[1] ='src/music/Rammstein-HILF MIR-kissvk.com.mp3'
song[2] ='src/music/Rammstein-MOSKAU-kissvk.com.mp3'
song[3] ='src/music/Rammstein-PUSSY-kissvk.com.mp3'
song[4] ='src/music/Rammstein-REISE- REISE-kissvk.com.mp3'
song[5] ='src/music/Rammstein-ROSENROT-kissvk.com.mp3'
song[6] ='src/music/Rammstein-SEX-kissvk.com.mp3'
song[7] ='src/music/Rammstein-SONNE-kissvk.com.mp3'
song[8] ='src/music/Rammstein-SPRING-kissvk.com.mp3'
song[9] ='src/music/Rammstein -Mann gegen mann-kissvk.com.mp3'
song[10] ='src/music/Rammstein-Du hast-kissvk.com.mp3'
        ...
        if (player.run) {
            switch (player.side) {
                case 1: // Top
                    ...
                    break;
                case 3: // Bottom
                    if (player.y < gameZone.getBoundingClientRect().bottom - player.h - 6) {
                        player.y += player.step;
                        player.el.style.top = `${player.y}px`;
                    }
                    break;
        ...
        bullets.forEach((bullet) => {
            ...
            switch (direction) {
                case 'top':
                    ...
                    break;
                case 'right':
                    if (bullet.getBoundingClientRect().right > gameZone.getBoundingClientRect().width - 10) {
                        bullet.parentNode.removeChild(bullet);
                    } else {
                    ...
                    break;
                case 'bottom':
                    if (bullet.getBoundingClientRect().bottom > gameZone.getBoundingClientRect().height - 10) {
                        bullet.parentNode.removeChild(bullet);
                    } else {
                        bullet.style.top = bullet.getBoundingClientRect().top + bulletSpeed + 'px';
                    }
        ...
        enemies.forEach((enemy) => {
            ...
            switch (direction) {
                case 'right':
                    ...
                    break;
                case 'left':
                    if (enemy.getBoundingClientRect().left >= gameZone.getBoundingClientRect().width - 10) {
                        enemy.parentNode.removeChild(enemy);
                    } else {
                        enemy.style.left = enemy.getBoundingClientRect().left + 3 + 'px';
                    }
                ...
                case 'top':
                    ...
                    break;
                case 'bottom':
                    if (enemy.getBoundingClientRect().bottom >= gameZone.getBoundingClientRect().height - 10) {
                        enemy.parentNode.removeChild(enemy);
                    } else {
                        enemy.style.top = enemy.getBoundingClientRect().top + 3 + 'px';
                    }
